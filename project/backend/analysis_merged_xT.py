...
def build_passing_graph_with_xt(events, starting_info):
    ...
    # Temporary storage for pass counts and xT sums
    ...
    for e in events:
        ...
        # Count passes and accumulate xT gain
        ...
        # Record location data for positioning
    ...
    # Compute average positions for all players
    positions = {
        player: (
...
def draw_network(G, positions, player_team, selected_team,
    ...
    # 2. Tetapkan panjang lapangan secara hard-code (StatsBomb default = 120)
    pitch_length = 120

    # 3. Hitung posisi plot, mirror untuk tim lawan
    positions_plot = {}
